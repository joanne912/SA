...
CREATE TABLE `apartment` (
  `APARTMENT_ID` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `APARTMENT_CITY` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `APARTMENT_DISTRICT` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `APARTMENT_NAME` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `facilities` (
  ...
  `APARTMENT_ID` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `facilities_booking` (
  ...
  `FACILITIES_BOOKING_TIME_ID` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `facilities_booking_time` (
  `FACILITIES_BOOKING_TIME_ID` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `FACILITIES_ID` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `facilities_repair` (
  `FACILITIES_REPAIRESIDENT_ID` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
ALTER TABLE `facilities_booking`
  ...
  ADD KEY `F_ID` (`FACILITIES_ID`),
  ADD KEY `FBT_ID` (`FACILITIES_BOOKING_TIME_ID`),
  ADD KEY `FE_ID` (`FACILITIES_EQUIPMENT_ID`);

--
-- 資料表索引 `facilities_booking_time`
--
ALTER TABLE `facilities_booking_time`
  ADD PRIMARY KEY (`FACILITIES_BOOKING_TIME_ID`),
  ADD KEY `facilities_booking_time_ibfk_1` (`FACILITIES_ID`);
...
ALTER TABLE `facilities_repair`
  ADD PRIMARY KEY (`FACILITIES_REPAIRESIDENT_ID`),
...
ALTER TABLE `household_address`
  ...
  ADD KEY `household_address_ibfk_1` (`APARTMENT_ID`);
...
--
ALTER TABLE `facilities`
  ADD CONSTRAINT `facilities_ibfk_1` FOREIGN KEY (`APARTMENT_ID`) REFERENCES `apartment` (`APARTMENT_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `facilities_booking`
  ...
  ADD CONSTRAINT `facilities_booking_ibfk_3` FOREIGN KEY (`FACILITIES_BOOKING_TIME_ID`) REFERENCES `facilities_booking_time` (`FACILITIES_BOOKING_TIME_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `facilities_booking_time`
  ADD CONSTRAINT `facilities_booking_time_ibfk_1` FOREIGN KEY (`FACILITIES_ID`) REFERENCES `facilities` (`FACILITIES_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `household_address`
  ADD CONSTRAINT `household_address_ibfk_1` FOREIGN KEY (`APARTMENT_ID`) REFERENCES `apartment` (`APARTMENT_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `manager`
  ...
  ADD CONSTRAINT `manager_ibfk_2` FOREIGN KEY (`APARTMENT_ID`) REFERENCES `apartment` (`APARTMENT_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
